          ...
          <div className='col-span-2'>
            <div className='mb-6'>
              <h1 className='text-3xl card-title'>
                {name}
                <div className='ml-2 mr-1 badge badge-accent badge-outline'>{type}</div>
                {hireable && (
                  <div className='mx-1 badge badge-primary badge-outline'>Hireable</div>
                )}
              </h1>
              <p>{bio}</p>
